...
| 5 | **NAC Residence Index — globe + section size (DESKTOP)** | Banner `min-height: 400px` — 50px breathing room each side of the 300px globe. Globe sits at `right: 2%` (close to text). Gradient is `linear-gradient(135deg, #faf9ff 0%, #ffffff 45%, #f4f7ff 100%)` — airy near-white, not heavy purple. |
