...
| 5 | **NAC Residence Index — globe + section size (DESKTOP)** | Banner `min-height: 300px` — globe-fit (no extra vertical padding). Globe sits at `right: 2%` (close to text, with a slight overflow). |
